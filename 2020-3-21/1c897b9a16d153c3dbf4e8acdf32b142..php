...
<title>COVID-19 Outbreak | Health &amp; Senior Services</title>
...
<div class="container">
  <div class="row">
    <div class="navbar-header"> <a href="/" class="navbar-brand text-hide">Missouri Department of Health &amp; Senior Services<img src="/img/health-logo.png" alt="Missouri Department of Health &amp; Senior Services Logo" class="col-xs-9" id="logo"></a>
        ...
        <div class="row">
          <div id="utility-bar" class="hidden-xs col-sm-8 col-md-9 col-lg-8">
            ...
            <ul>
              ...
              <li><a href="https://governor.mo.gov" class="new-window">Governor Parson</a></li>
          ...
          <div id="search" role="search" class="col-xs-12 col-sm-4 col-md-3 col-lg-4"> 
           ...
           <!-- <form action="https://search.mo.gov/search" method="get">
              <fieldset>
                ...
                <input type="hidden" name="site" value="dhss"/>
                <input type="hidden" name="output" value="xml_no_dtd"/>
                <input type="hidden" name="client" value="dhss"/>
                <input type="hidden" name="num" value="10"/>
                <input type="hidden" name="proxystylesheet" value="dhss"/>
              </fieldset>
            </form> -->
			 <form method="get" action="https://searchapp.mo.gov/search-missouri/dhss" id="search-form">
              <fieldset>
                <legend class="sr-only">Search</legend>
                <div class="form-group">
                  <label for="siteQ" class="sr-only">Search</label>
...
<div class="container">
  <div id="content"> 
    ...
    <section id="main-content" role="main" class="col-md-8">
      ...
      <div class="mobile hidden-md hidden-sm hidden-lg">
        <p><a href="https://info.mo.gov/covid/" target="_blank"><img src="/img/covid-19-chat.png" class="img-responsive center-block" alt="Have questions? chat about COVID-19"></a></p>
      </div>
      <div class="margin-bottom-20"></div>
      <div class="clearfix"></div>
      <div class="panel-group" id="accordion">
        <div class="panel panel-default"> <a class="accordion-trigger collapsed" aria-expanded="false" href="#collapseOne" data-toggle="collapse">
          <div class="panel-heading" data-parent="#accordion">
            <h4 class="panel-title"> Cases by County <i class="indicator glyphicon pull-right glyphicon-chevron-down" aria-hidden="true"></i> </h4>
          </div>
          </a>
          <div class="panel-collapse collapse" id="collapseOne" aria-expanded="false" style="height: 0px;">
            <div class="panel-body">
              <div class="table w-auto">
                <table class="table col-xs-12 col-md-12 col-sm-12">
                  <tbody>
                    <tr>
                      <th>County
                        </td>
                      <th class="text-center">Positive by State Public Health Laboratory
                        </td>
                      <th class="text-center">Positive by Commercial or Other Laboratory
                        </td>
                    </tr>
                    <tr>
                      <td>Boone</td>
                ...
                <p class="small">Cases by county will be updated as information is verified and patients are notified. The breakdown may not match the total case count above.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="panel panel-default"> <a class="accordion-trigger" href="#collapseTwo" data-toggle="collapse">
          <div class="panel-heading" data-parent="#accordion">
            <h4 class="panel-title"> Cases by Age Range <i class="indicator glyphicon pull-right glyphicon-chevron-down" aria-hidden="true"></i> </h4>
          </div>
          </a>
        ...
        <div class="panel panel-default"> <a class="accordion-trigger" href="#collapseThree" data-toggle="collapse">
          <div class="panel-heading" data-parent="#accordion">
            <h4 class="panel-title"> Travel or Contact Related Case Counts <i class="indicator glyphicon pull-right glyphicon-chevron-down" aria-hidden="true"></i> </h4>
          </div>
          </a>
            ...
            <div class="panel-body">
              <div class="table w-auto">
                <table class="table col-xs-12 col-md-12 col-sm-12">
                  <tbody>
                    <tr>
                      <th class="text-center">Travel or contact to Confirmed Case</th>
                      <th class="text-center">Number of Cases</th>
                    </tr>
                    <tr>
                      <td>Travel</td>
      ...
      <!--iframe width="748" height="500" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="COVID-19" src="https://www.arcgis.com/apps/opsdashboard/index.html#/1fd32012487c4e5c936a13389f9731c3"></iframe>

<h3><a href="https://missouri-coronavirus-gis-hub-mophep.hub.arcgis.com/">Missouri Coronavirus GIS Hub</a></h3--> 
  ...
  <div class="list-group"> <a href="https://www.cdc.gov/coronavirus/2019-nCoV/summary.html" class="list-group-item">CDC Situation Summary</a> <a href="https://www.cdc.gov/coronavirus/2019-ncov/faq.html" class="list-group-item">Frequently Asked Questions and Answers</a> <a href="missouri-news.php" class="list-group-item">Missouri News</a> <a href="waivers-laws-rules.php" class="list-group-item">Waivers of Laws and Rules</a>
    <!--Related Links--> 
  </div>
</div>
<div class="mobile hidden-xs"><p><a href="https://info.mo.gov/covid/" target="_blank"><img src="/img/covid-19-chat.png" class="img-responsive" alt="Have questions? chat about COVID-19"></a></p></div>
<div class="margin-bottom-20"></div>
  ...
  <div class="panel-body margin-bottom-20">
    <h3>24 hour hotline: 877-435-8411</h3>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-3">
        ...
        <ul>
          ...
          <li><a href="/about/directory-of-services.php">Directory of Services</a></li>
      ...
      <div class="col-sm-6 col-md-3">
        <div id="connect">
          ...
          <ul>
            ...
            <li><a title="Follow us on Twitter" target="_blank" class="twitter text-hide external" href="http://twitter.com/HealthyLivingMo">Twitter</a></li>
            <li><a title="Subscribe to our YouTube channel" target="_blank" class="youtube text-hide new-window" href="http://www.youtube.com/user/MODHSS">YouTube</a></li>
            ...
            <!--<li><a title="Connect with us on LinkedIn" target="_blank" class="linkedin text-hide external" href="https://www.linkedin.com/company/state-of-missouri">LinkedIn</a></li>--> 
            <!--<li><a title="Contact us" class="email text-hide" href="https://www.mo.gov/contact-us/">Email</a></li>-->
            <li><a title="Subscribe to our newsfeed" target="_blank" class="rss text-hide" href="http://health.mo.gov/information/news/rss.xml">RSS</a></li>
            <!--<li><a title="Follow us on GooglePlus" target="_blank" class="googleplus text-hide" href="https://plus.google.com/+mogov">Google+</a></li>--> 
      ...
      <div id="leadership" class="col-md-3">
        <p class="mogov"><a href="https://www.missouriorgandonor.com/odpublicsite/Default.aspx" title="missouriorgandonor.com | Donate Life Missouri" class="savelife-seal text-hide external">Click Here to Save a Life</a></p> 
		<p class="mogov"><a href="https://www.phaboard.org/" title="phaboard.org | Public Health Accreditation Board" class="phab-seal text-hide external">Public Health Accreditation Board</a></p>
		</div>
      
      <div class="clearfix"></div>
      <div id="leadership" class="clearfix hidden-xs col-md-12">
        <p><a href="https://governor.mo.gov/" title="Official Website of Governor Michael L. Parson" class="gov">Governor<br/>
          Michael L. Parson</a></p>
        ...
        <p><a href="/about/director.php" title="Missouri Department of Health and Senior Services Office" class="agency">Director<br/>
          Randall W. Williams, MD, FACOG</a></p>
      </div>
      <!--end leadership-->
...
<script async type="text/javascript" src="/_Incapsula_Resource?SWJIYLWA=719d34d31c8e3a6e6fffd425f7e032f3&ns=1&cb=1767315182"></script>
</body>
</html>